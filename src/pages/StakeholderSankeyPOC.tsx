...
export const StakeholderSankeyPOC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Narrative - centered in gap between toggle (~110px) and Sankey visual (~240px) */}
      ...
      <div className="absolute top-[230px] bottom-[20px] left-0 right-0 flex items-center justify-center">
